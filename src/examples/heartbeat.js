...
setInterval(client.sendHeartbeatMessage({ onResponse: response => console.log(response)}), 2000);
setInterval(client.sendLogoffMessage({ onResponse: response => console.log(response) }), 4000);
