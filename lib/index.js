...
var BatchOrdersParams = function BatchOrdersParams(_ref) {
  var orders = _ref.orders;

  _classCallCheck(this, BatchOrdersParams);
...
var OpoParams = function OpoParams(_ref) {
  var primary = _ref.primary,
      _ref$secondaryBatch = _ref.secondaryBatch,
      secondaryBatch = _ref$secondaryBatch === void 0 ? undefined : _ref$secondaryBatch,
      _ref$secondaryOco = _ref.secondaryOco,
      secondaryOco = _ref$secondaryOco === void 0 ? undefined : _ref$secondaryOco;

  _classCallCheck(this, OpoParams);
  ...
  */
  ...
  } else if (secondaryBatch === undefined && secondaryOco === undefined) {
    throw new Error(errors$2.MissingArgument);
  } else {
    throw new Error(errors$2.TooManyArguments);
  }
};

var OcoParams = function OcoParams(_ref) {
  var orders = _ref.orders;

  _classCallCheck(this, OcoParams);
...
exports.BatchOrdersParams = BatchOrdersParams;
...
exports.OcoParams = OcoParams;
exports.OpoParams = OpoParams;
...
exports.messageBodyTypes = messageBodyTypes;
